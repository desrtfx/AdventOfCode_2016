 ...
 * from the rest of the building except for a small dedicated lobby. 
 ...
 * to experiment with Radioisotope Thermoelectric Generators (RTGs, or simply "generators") 
 ...
 * to generate an elecromagnetic radiation shield when powered. 
 ...
 * Therefore, it is assumed that you will follow procedure and keep chips connected 
 * to their corresponding RTG when they're in the same room, 
 ...
 * assembling machine which can make a self-contained, shielded computer 
 ...
 * to have these pre-assembly RTGs), there is an elevator that can move between 
 * the four floors. Its capacity rating means it can carry at most yourself and 
 * two RTGs or microchips in any combination. (They're rigged to some heavy diagnostic equipment - 
 ...
 * The elevator always stops on each floor to recharge, and this takes long enough that 
 ...
 * Before you don a hazmat suit and start moving things around, 
 ...
 * L for Lithium, M for Microchip, and G for Generator), the initial state looks like this:
 * 
 * F4 .  .  .  .  .  
 * F3 .  .  .  LG .  
 * F2 .  HG .  .  .  
 ...
 * which is safe because you can connect the Lithium-compatible Microchip 
 ...
 * at the fourth floor for assembly. (Each elevator stop counts as one step, 
 * even if nothing is added to or removed from it.)
 * 
 * In your situation, what is the minimum number of steps required 
 * to bring all of the objects to the fourth floor?
 */
